...
export const Register = () => {
    ...
    return (
        <div className='h-[calc(100vh-120px)] justify-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 mb-4 pb-8 '>
                ...
                <p className='align-baseline font-medium mt-4 text-sm'> Haven an account <Link to="/login" className='text-blue-500 hover:text-blue-700'>Login</Link>  to Submit Reviews</p>
