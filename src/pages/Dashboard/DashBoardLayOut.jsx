                ...
                <div className="flex-grow text-gray-800">
                    ...
                    <main className="p-6 sm:p-10 space-y-6">
                        ...
                        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                            ...
                            <div className="flex flex-col md:flex-row items-start justify-end -mb-3 space-x-0 md:space-x-6">
                                <Link
                                ...
                                <Link
                                    to="/dashboard/manage-book-reviews"
                                    className="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3"
                                >
                                    Manage Reviews
                                </Link>
                        ...
                        <main className="flex-1 w-full h-full bg-gray-100 p-4 overflow-auto">
                            <Outlet />
                        </main>
                        ...
                        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                            ...
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="inline-block text-xl text-gray-500 font-semibold ml-2">(13%)</span>
